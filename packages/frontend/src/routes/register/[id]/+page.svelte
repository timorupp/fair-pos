...
<style>
  ...
  .register-header h1 { font-size: 1.125rem; font-weight: 700; margin: 0; }
  .lock-screen {
  ...
  .empty { color: var(--color-text-muted); font-size: 0.925rem; padding: 0.5rem 0; }
  ...
  .line-unit { font-size: 0.875rem; text-align: right; }
  ...
  .qty-val { min-width: 1.5em; text-align: center; font-weight: 700; font-size: 1.125rem; }

  .total-row {
    display: flex; align-items: center; gap: 0.75rem;
    padding-top: 0.6rem; margin-top: 0.5rem; border-top: 1px solid var(--color-border);
  }
  .total-value { font-size: 1.275rem; font-weight: 700; flex: 1; }
  .total-value.negative { color: var(--color-danger); }
  .checkout-btn { padding: 0.6rem 1.5rem; font-size: 1.025rem; }
  ...
  .grid-btn {
    border: none; border-radius: var(--radius); color: white; font-weight: 700; font-size: 1.05rem;
