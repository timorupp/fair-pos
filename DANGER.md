...
| ID | Schwere | Bereich | Beschreibung | Vorschlag | Gefunden |
|----|---------|---------|--------------|-----------|----------|
| D-009 | hoch | Compliance | QR-Code-Payload (`receipt/qr.ts`) verwendet ein selbst-erfundenes Format (semikolon-getrennt). Der BSI TR-03151 / DSFinV-K-Standard sieht einen spezifischen Bytestrom vor. | Vor dem ersten Echteinsatz mit TSE: gegen BSI-Spezifikation prüfen und Layout anpassen. | 2026-06-24 |
